(function(){
	window.onload=function(){
			...
			$('#success_top_right_div_five').click(function(){
			...
			$('#success_top_right_div_five1').mousemove(function(){
				$('#success_top_right_div_five1').css('border-top-color','blue')
				$('#success_top_right_div_five1 p').css('color','blue')
			})
			$('#success_top_right_div_five1').mouseout(function(){
				$('#success_top_right_div_five1').css('border-top-color','transparent')
				$('#success_top_right_div_five1 p').css('color','#000000')
			})
...
function showAppimg(){
		...
		var appImg=['{{C.PATH.PUBLIC}}images/instructions_02.jpg','{{C.PATH.PUBLIC}}images/instructions_03.jpg','{{C.PATH.PUBLIC}}images/instructions_04.jpg','{{C.PATH.PUBLIC}}images/instructions_05.jpg','{{C.PATH.PUBLIC}}images/instructions_06.jpg','{{C.PATH.PUBLIC}}images/instructions_07.jpg','{{C.PATH.PUBLIC}}images/instructions_8.jpg'] 
         //创建一个div
...
function showPanicimg(){
		var swiper=document.getElementById("new_show_img_ins");
		var appImg=['{{C.PATH.PUBLIC}}images/panic_02.jpg','{{C.PATH.PUBLIC}}images/panic_03.jpg','{{C.PATH.PUBLIC}}images/panic_04.jpg','{{C.PATH.PUBLIC}}images/panic_05.jpg'] 
         //创建一个div
		for(var i=0;i<appImg.length;i++){
			// var div = document.createElement('div');
			// div.className = "swiper-slide";
