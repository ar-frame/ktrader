...
class Weixin extends Component
{
    ...
    {
        if (!\ar\core\comp('cache.db')->get('wx_token')) :
            ...
            $resultArray = $this->handlerRemoteData($result);
            \ar\core\comp('cache.db')->set('wx_token', $resultArray['access_token'], '7200');
        endif;

        return \ar\core\comp('cache.db')->get('wx_token');
    ...
    {
        if (!\ar\core\comp('cache.db')->get('wx_jsticket')) :
            $accessToken = $this->getAccessToken();
            ...
            $resultArray = $this->handlerRemoteData($result);
            \ar\core\comp('cache.db')->set('wx_jsticket', $resultArray['ticket'], $resultArray['expires_in']);
        endif;

        return \ar\core\comp('cache.db')->get('wx_jsticket');
