...
class Mysql extends Db
{
    ...
    protected function query($sql = '')
    {
        ...
        try {
            ...
            // 重连
            if ((strpos($e->getMessage(), 'Lost connection to MySQL server') !== false) || (strpos($e->getMessage(), 'server has gone away') !== false) || (strpos($e->getMessage(), 'Broken pipe') !== false) ||  (strpos($e->getMessage(), 'while other unbuffered queries are active') !== false)) :
                $connection = null;
