layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'modelname', title: '模型名', minWidth:100, align:"center"},
            {field: 'tablename', title: '数据表名', minWidth:200, align:'center'},
            // {field: 'budget', title: '总记录数', minWidth:150, align:'center'},
            {title: '操作', minWidth:175, templet:'#modelListBar',fixed:"right",align:"center"}
        ]]
    });
