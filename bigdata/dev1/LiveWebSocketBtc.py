...
db_trades = MongoDB('bigdata-btc', 'gataio_eth_trades_h' + nowHour, dbHost = '127.0.0.1' , dbUser = None)
#db_trades = MongoDB('bigdata-btc', 'gataio_eth_trades_h' + nowHour)
...
def on_open(ws):
    ...
    def run(*args):
        datatrades = {'id': markid, 'method': "trades.subscribe", 'params': ["BTC_USDT"]}
...
def connect():
    ...
    try:
        if ws is None :
            print('start connect')
            ws = websocket.WebSocketApp("wss://webws.gateio.live/v3/",
