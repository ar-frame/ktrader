...
from HttpUtil import getSign, httpGet, httpPost, httpPostRequest
...
class GateIO:
    ...
    # 买入
    def buy(self, currencyPair,rate, amount, orderType = "ioc"):
        URL = "/api2/1/private/buy"
        params = {'currencyPair': currencyPair,'rate':rate, 'amount':amount, 'orderType': orderType}
        return httpPostRequest(self.__url, URL, params, self.__apiKey, self.__secretKey)

    # 卖出
    def sell(self, currencyPair, rate, amount, orderType = "ioc"):
    ...
    # 取消批量订单
    def cancelOrders(self, orders_json):
        URL = "/api2/1/private/cancelOrders"
        params = {'orders_json': orders_json}
        return httpPost(self.__url, URL, params, self.__apiKey, self.__secretKey)
    ...
    def cny_price(self, param = ''):
        URL = "/api2/1/ticker/usdt_cny"
        return httpGet(self.__url, URL, param)

    def eth_price(self, param = ''):
        URL = "/api2/1/ticker/eth_usdt"
        return httpGet(self.__url, URL, param)
